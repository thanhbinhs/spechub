...
const VERSION = "automatic-device-score-v1.0.0";
...
const phonePerformance = scoreModule(
  "performance",
  "Hiệu năng",
...
const phoneDisplay = scoreModule(
  "display",
  "Màn hình",
...
const phoneBattery = scoreModule(
  "battery",
  "Pin & sạc",
...
const laptopDisplay = scoreModule(
  "display",
  "Màn hình",
...
const laptopBattery = scoreModule(
  "battery",
  "Pin & sạc",
...
const memoryStorage = scoreModule(
  "memory-storage",
  "Bộ nhớ & lưu trữ",
...
const laptopConnectivity = scoreModule(
  "connectivity",
  "Cổng & kết nối",
...
const profiles: ScoringProfile[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      scoreModule("battery", "Pin", "Thời lượng sử dụng và tốc độ sạc.", 20, [
